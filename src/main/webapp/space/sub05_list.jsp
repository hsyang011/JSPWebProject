...
session.setAttribute("tname", "info_board");
session.setAttribute("seqname", "seq_info_num");
%>
...
%>
	<tr>
		...
		<td class="text-left"><a href="sub05_view.jsp?num=<%= dto.getNum() %>"><%= dto.getTitle() %></a></td>
