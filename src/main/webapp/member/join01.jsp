...
$(function() {
	$("#agreeChk").click((e) => {
		var isChecked = $("input[name=agreement1]").is(":checked");
		
		if (isChecked) {
			location.href = "join02.jsp";
		} else {
			alert("약관 동의하고 시도해주세요.");
		}
	});
});
</script>
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px"><a href="javascript:void(0)"><img src="../images/btn01.gif" id="agreeChk" /></a>&nbsp;&nbsp;<a href="./login.jsp"><img src="../images/btn02.gif" /></a></p>
