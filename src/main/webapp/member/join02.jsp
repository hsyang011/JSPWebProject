	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<!-- 회원가입 폼 -->
				<form action="joinAction.jsp" name="joinForm" onsubmit="return formValidate(this);">
				<table cellpadding="0" cellspacing="0" border="0" class="join_box">
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="tel3" value="" maxlength="4" class="join_input" style="width:50px;" onkeyup="focusMove(this, 'mobile1', 4);" />
						</td>
					</tr>
					<tr>
